...
// =====================================================================
//  PIN DEFINITIONS (V4 - Custom 38-pin ESP32 DevKit PCB)
// =====================================================================
...
static void set_tank_sides(int left_pct, int right_pct) {
    ...
    // M1 and M3 are the left side. M2 and M4 are the right side.
...
static robot_drive_t drive_from_direction(robot_dir_t dir, int speed) {
    ...
    switch (dir) {
        ...
        case DIR_LEFT:      return (robot_drive_t){-speed,  speed};
        case DIR_RIGHT:     return (robot_drive_t){ speed, -speed};
...
void task_motion(void *arg) {
    ESP_LOGI(TAG, "Initializing Curie V4 motion system: 4 drivers, tank behavior, 2 shoulders");
